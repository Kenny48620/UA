...
int testcase_main()
{
    ...
    fork1("XXp1", XXp1, "XXp1", USLOSS_MIN_STACK, 3);
...
int XXp1(char *arg)
{
    ...
    kidpid = fork1("XXp2", XXp2, "XXp2", USLOSS_MIN_STACK, 2);
...
//     USLOSS_Console("XXp1(): after fork of child %d -- you should never see this.\n", kidpid);
